...
public class BulletModel extends GameObject {
    ...
    public BulletModel(FuriousBadi game, World world, GunModel gun, float width, float height, float textureWidth, float textureHeight, String texturePath, float speed) {
    ...
    public void createBody() {
        ...
        fixtureDef.filter.maskBits = BIT_GAME_BABY_ENEMY | BIT_MENUBUTTON | BIT_MENUWALLS | BIT_GAME_GROUND | BIT_GAME_BULLET | BIT_GAME_FIRING_ENEMY | BIT_GAME_BOX;
