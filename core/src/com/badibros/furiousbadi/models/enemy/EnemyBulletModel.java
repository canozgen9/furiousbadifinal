...
public class EnemyBulletModel extends GameObject {
    ...
    public EnemyBulletModel(FuriousBadi game, World world, EnemyGunModel gun, float width, float height, float textureWidth, float textureHeight, String texturePath, float speed) {
        super(game, world, gun.enemy.getB2d().getPosition().x, gun.enemy.getB2d().getPosition().y);
        this.speed = speed;
        this.width = width;
        this.height = height;
        this.gun = gun;
    ...
    public void prepareObject() {
        ...
        getB2d().applyLinearImpulse((gun.isFacingRight ? speed : -speed), 0, getB2d().getWorldCenter().x, getB2d().getWorldCenter().y, false);
    ...
    public void createBody() {
        ...
        if (gun.enemy.runningRight) {

            bodyDef.position.set(gun.enemy.getB2d().getPosition().x + GameVariables.scale(20), gun.enemy.getB2d().getPosition().y + GameVariables.scale(20));
